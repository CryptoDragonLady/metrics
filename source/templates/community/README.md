<table>
  ...
  Community templates are a way to use official releases of [CryptoDragonLady/metrics](https://github.com/CryptoDragonLady/metrics) while using templates from external repositories (owned or not).
...
with:
  ...
  template: "@classic"
  setup_community_templates: CryptoDragonLady/metrics@master:classic
...
with:
  token: ${{ secrets.METRICS_TOKEN }}
  template: "@terminal"
  setup_community_templates: CryptoDragonLady/metrics@master:terminal+trust
