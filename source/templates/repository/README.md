...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="https://github.com/CryptoDragonLady/metrics/blob/examples/metrics.repository.svg" alt=""></img>
...
*Example: render `CryptoDragonLady/metrics` repository*
```yml
...
with:
  ...
  plugin_followup: yes
  plugin_projects: yes
  plugin_projects_repositories: CryptoDragonLady/metrics/projects/1
